...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_voyager(
    ...
    KC_TAB,         KC_X,           KC_W,           KC_M,           KC_G,           KC_J,                                           KC_Z,           KC_DOT,         KC_SLSH,        KC_Q,           KC_QUOT,        KC_MINS,
    KC_ESC,         KC_S,           KC_C,           KC_N,           KC_T,           KC_K,                                           KC_COMM,        KC_A,           KC_E,           KC_I,           KC_H,           KC_SCLN,
    KC_LALT,        KC_B,           KC_P,           KC_L,           KC_D,           KC_V,                                           KC_GRV,         KC_U,           KC_O,           KC_Y,           KC_F,           KC_ENT,
                                                                    KC_SPC,         KC_BSPC,                                        KC_ENT,         KC_R
  ),
  [SYM] = LAYOUT_voyager(
