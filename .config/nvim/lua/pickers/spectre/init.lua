...
local search_tree = require("pickers.spectre.search_tree")

function fn.isome(tbl, func)
...
function fn.ifilter(tbl, pred_fn)
...
function fn.ireject(tbl, pred_fn)
	return fn.ifilter(tbl, function(value, index)
